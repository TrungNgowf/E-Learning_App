              ...
              CustomButton(
                ...
                onTap: () {
                  if (formKey.currentState!.saveAndValidate()) {
                    String about = generateHtml(aboutControllers);
                    String qualifications =
                        generateHtml(qualificationControllers);
                    String experience = generateHtml(experimentControllers);
                    _controller.submitForm(formKey.currentState!.value, about,
